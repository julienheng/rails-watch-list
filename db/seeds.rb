...
list1 = List.create(name: "Thriller")
list2 = List.create(name: "Action")
list3 = List.create(name: "International")
list4 = List.create(name: "Documentary")


Bookmark.create(comment: "Must watch movies!", movie: movie1, list: list1)
Bookmark.create(comment: "Watch later!", movie: movie2, list: list1)
Bookmark.create(comment: "recommended!", movie: movie3, list: list1)
Bookmark.create(comment: "Oscar award winnings!", movie: movie4, list: list4)
